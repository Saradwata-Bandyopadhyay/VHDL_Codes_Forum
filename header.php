<head>
    ...
    <title>VHDL Codes Forum</title>
    <meta content="VHDL (VHSIC-HDL, Very High Speed Integrated Circuit Hardware Description Language) is a hardware description language. Search for your programs here. All programs are tested in ModelSim." name="description">
  ...
  <body>
    <nav class="navbar navbar-expand-lg sticky-top bg-warning">
        <div class="container-fluid">
          <a class="navbar-brand" href="/">VHDL</a>
